...
draw_healthbar(x-TILE_SIZE, y-1.5*TILE_SIZE, x+TILE_SIZE, y-1.3*TILE_SIZE, objController.player_health[0], c_black, c_red, c_green, 0, true, true)
...
if view_current = current_player // only draw in players view
{
    ...
    enemy_id = instance_nearest(x, y, objPlayer2)
